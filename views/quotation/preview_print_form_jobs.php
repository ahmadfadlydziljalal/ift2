...
/* @var $quotationFormJobs QuotationFormJob[] */

?>


<?php foreach ($quotationFormJobs as $quotationFormJob) : ?>
            ...
            <div class="mb-1" style=" float: right; width: 52%">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="border-start-0">
                            <?= !empty($quotationFormJob->cardOwnEquipment)
                                ? $quotationFormJob->cardOwnEquipment->nama . ' | ' . $quotationFormJob->cardOwnEquipment->serial_number
                                : ""
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="border-start-0">
                            <?= !empty($quotationFormJob->cardOwnEquipment)
                                ? $quotationFormJob->cardOwnEquipment->card->nama
                                : ""
                            ?>
                        </td>
                    </tr>
