        ...
        <div class="d-flex flex-row gap-2">
            ...
            <div class="ms-auto">
                <?php if (!$model->proformaInvoice->proformaInvoiceDetailBarangs) : ?>
                    ...
                    <?= Html::a('<div class="d-flex flex-nowrap gap-1"><i class="bi bi-plus-circle"></i> Tambah Barang</div>', ['quotation/create-proforma-invoice-detail-barang', 'id' => $model->proformaInvoice->id], [
