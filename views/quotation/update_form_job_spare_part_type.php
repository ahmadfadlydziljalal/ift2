...
/* @see \app\controllers\QuotationController::actionUpdateFormJobServicePartType() */

use yii\helpers\Html;

$this->title = 'Update - Spare Part - ' . $quotationFormJobModel->nomor;
...
<div class="quotation-form-job-spare-part-update">
