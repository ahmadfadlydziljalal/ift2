...
class m221202_003329_CreateHistoryLokasiBarangTable extends Migration
{
   ...
   public function safeUp()
   {
      ...
      $this->batchInsert('status', ['id', 'section', 'key', 'value', 'options'], [
         ...
         [9, 'set-lokasi-barang', 'movement', 20, '{ "tag": "span", "options": { "class": "badge bg-primary" } }'],
         [10, 'set-lokasi-barang', 'pembatalan', 30, '{ "tag": "span", "options": { "class": "badge bg-primary" } }'],
         [11, 'set-lokasi-barang', 'out', 40, '{ "tag": "span", "options": { "class": "badge bg-primary" } }'],
      ]);
