...
class QuotationFormJob extends BaseQuotationFormJob {
    ...
    public ?string $cardOwnEquipmentMerkType = null;
    public ?string $cardOwnEquipmentProductionNo = null;
    ...
    public function rules(): array {
        return ArrayHelper::merge(
            ...
            [
                ...
                [['cardOwnEquipmentMerkType', 'cardOwnEquipmentProductionNo'], 'safe'],
            ]
        );
    }
    ...
    public function attributeLabels(): array {
        return ArrayHelper::merge(
            ...
            [
                ...
                'cardOwnEquipmentMerkType' => 'Merk/Type'
            ]
        );
    }
