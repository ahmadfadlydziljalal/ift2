...
class PurchaseOrder extends BasePurchaseOrder implements MasterDetailsInterface
{
    ...
    public function getStatusTandaTerima(): string
    {
        return isset($this->tandaTerimaBarang);
    }


    public function getStatusTandaTerimaInHtmlLabel(): string
    {
        return isset($this->tandaTerimaBarang)
            ?
            $this->tandaTerimaBarang->getStatusInHtmlLabel()
            :
