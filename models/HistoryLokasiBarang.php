...
class HistoryLokasiBarang extends BaseHistoryLokasiBarang {
    ...
    public function getNomorDokumenPendukung(): string {
        if (!empty($this->tanda_terima_barang_detail_id)):
            return
                $this->tandaTerimaBarangDetail->tandaTerimaBarang->nomor . ' | ' .
                $this->tandaTerimaBarangDetail->materialRequisitionDetailPenawaran->materialRequisitionDetail->barang->nama . ' | ' .
                $this->tandaTerimaBarangDetail->materialRequisitionDetailPenawaran->materialRequisitionDetail->barang->part_number;
        endif;
